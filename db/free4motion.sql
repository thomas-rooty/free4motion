...
CREATE TABLE IF NOT EXISTS `free4motion`.`Contrat` (
  ...
  `numeroCb` VARCHAR(255) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `free4motion`.`cb` (
  `idCb` VARCHAR(255) NOT NULL,
  `expMonth` INT(11) NULL DEFAULT NULL,
  `expYear` INT(11) NULL DEFAULT NULL,
  `last4` VARCHAR(4) NULL DEFAULT NULL,
  `idPersonne` INT(11) NULL DEFAULT NULL,
  PRIMARY KEY (`idCb`),
  INDEX `idPersonne_idx` (`idPersonne` ASC) VISIBLE,
  UNIQUE INDEX `idCb_UNIQUE` (`idCb` ASC) VISIBLE,
